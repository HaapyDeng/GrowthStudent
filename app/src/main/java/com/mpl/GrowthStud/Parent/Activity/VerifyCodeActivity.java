        ...
        client.get(url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (code == 0) {
                        Toast.makeText(VerifyCodeActivity.this, R.string.activate_success, Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(VerifyCodeActivity.this, PMainActivity.class);
                        startActivity(intent);
                        finish();
                        return;
                    } else {
                        Toast.makeText(VerifyCodeActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                        return;
                    }
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                Toast.makeText(VerifyCodeActivity.this, R.string.no_network, Toast.LENGTH_LONG).show();
                return;
            }
        ...
        client.post(url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    int code = response.getInt("code");
                    if (code == 0) {
                        Toast.makeText(VerifyCodeActivity.this, R.string.send_code_success, Toast.LENGTH_LONG).show();
                        return;
                    } else {
                        Toast.makeText(VerifyCodeActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                        return;
