...
import com.mpl.GrowthStud.Student.Activity.ChengJiuDaiWanChengFragment;
import com.mpl.GrowthStud.Student.Activity.ChengJiuJinXingZhongFragment;
import com.mpl.GrowthStud.Student.Activity.ChengJiuYiWanChengFragment;
...
public class PEchievementActivity extends FragmentActivity implements View.OnClickListener {
    private PChengJiuYiWanChengFragment fragment1;
    private PChengJiuJinXingZhongFragment fragment2;
    private PChengJiuDaiWanChengFragment fragment3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pechievement);
        //初始化参数
    ...
    private void initData(CharSequence choose_start_time, CharSequence choose_end_time, String categoryid, String lableid) {
        if (!NetworkUtils.checkNetWork(PEchievementActivity.this)) {
            Toast.makeText(PEchievementActivity.this, R.string.no_network, Toast.LENGTH_LONG).show();
            return;
        }
        String cid;
        ...
        String url = getResources().getString(R.string.local_url) + "/v1/achievement/default/statistical/" + 1 + "/" + cid + "/" + choose_start_time + "/" + choose_end_time + "/" + categoryid + "/" + lableid;
        Log.d("url==>>", url);
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (code == 0) {
                        ...
                        Toast.makeText(PEchievementActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                        return;
                    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_start_time:
                ...
                DatePickerDialog dialog = new DatePickerDialog(PEchievementActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.tv_end_time:
                ...
                DatePickerDialog dialog2 = new DatePickerDialog(PEchievementActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            case R.id.tv_clear:
                ...
                CategoryListViewAdapter categoryListViewAdapter = new CategoryListViewAdapter(PEchievementActivity.this, listLableListItem);
    ...
    private void getCategoryList() {
        if (NetworkUtils.checkNetWork(PEchievementActivity.this) == false) {
            Toast.makeText(PEchievementActivity.this, R.string.no_network, Toast.LENGTH_LONG).show();
            return;
        }
        SharedPreferences sharedPreferences = PEchievementActivity.this.getSharedPreferences("myinfo", MODE_PRIVATE);
        String token = sharedPreferences.getString("token", "");
                ...
                try {
                    ...
                    if (code == 0) {
                        ...
                        if (list.length() <= 0) {
                            ...
                            CategoryListViewAdapter categoryListViewAdapter = new CategoryListViewAdapter(PEchievementActivity.this, listCategoryListItem);
...
//                transaction.show(fragment1);
                if (fragment1 == null) {
                    fragment1 = new PChengJiuYiWanChengFragment();
                }
            ...
            case 1:
                ...
                if (fragment2 == null) {
                    fragment2 = new PChengJiuJinXingZhongFragment();
                }
            ...
            case 2:
                ...
                if (fragment3 == null) {
                    fragment3 = new PChengJiuDaiWanChengFragment();
                }
