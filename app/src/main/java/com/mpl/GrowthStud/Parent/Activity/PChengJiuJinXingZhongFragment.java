...
public class PChengJiuJinXingZhongFragment extends Fragment {
    ...
    private void getCpmpletAchieve(CharSequence choose_start_time, CharSequence choose_end_time, String categoryid, String lableid) {
        ...
        String url = getResources().getString(R.string.local_url) + "/v1/achievement/default/statistical/" + "2/" + cid + "/" + choose_start_time + "/" + choose_end_time + "/" + categoryid + "/" + lableid;
        Log.d("url==>>", url);
