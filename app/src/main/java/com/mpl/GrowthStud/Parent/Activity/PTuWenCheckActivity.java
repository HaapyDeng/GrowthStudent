...
public class PTuWenCheckActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    gridview = findViewById(R.id.gridview);
                    gridview.setAdapter(new PImageAdapter(PTuWenCheckActivity.this, listImage));
                    ShowPopuWindow();
                    break;
    ...
    private void ShowPopuWindow() {
        ...
        // 声明平移动画
        popupView = View.inflate(PTuWenCheckActivity.this, R.layout.check_evaluate_item, null);
        ...
        popupWindow.showAtLocation(PTuWenCheckActivity.this.findViewById(R.id.tv_answer), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
        ...
        tv_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (contentText[0].equals("")) {
                    Toast.makeText(PTuWenCheckActivity.this, "请添加评审内容", Toast.LENGTH_SHORT).show();
                    return;
                }
