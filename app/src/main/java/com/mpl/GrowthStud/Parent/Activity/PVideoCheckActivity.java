...
import com.mpl.GrowthStud.Student.Activity.VideoPlayActivity;
...
public class PVideoCheckActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pvideo_check);
    ...
    private void initData() {
        if (!NetworkUtils.checkNetWork(PVideoCheckActivity.this)) {
            Toast.makeText(PVideoCheckActivity.this, R.string.no_network, Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private void ShowPopuWindow() {
        ...
        // 声明平移动画
        popupView = View.inflate(PVideoCheckActivity.this, R.layout.check_evaluate_item, null);
        ...
        popupWindow.showAtLocation(PVideoCheckActivity.this.findViewById(R.id.tv_answer), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
        ...
        tv_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (contentText[0].equals("")) {
                    Toast.makeText(PVideoCheckActivity.this, "请添加评审内容", Toast.LENGTH_SHORT).show();
                    return;
                }
