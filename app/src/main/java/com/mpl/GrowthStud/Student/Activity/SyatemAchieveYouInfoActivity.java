...
public class SyatemAchieveYouInfoActivity extends AppCompatActivity implements View.OnClickListener {
    private LinearLayout back;
    private TextView tv_title, tv_male, tv_birthy, tv_animal, tv_lable, tv_time;
    private TextView tv_lable2, tv_lable3, tv_lable4, tv_lable5;
    private String achieveId;
    private String headTitle;
    private TextView tv_username, tv_position;
    private String username, male, birthday, animal, postion, updated_at, name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_syatem_achieve_you_info);
    ...
    private void initData(String achieveId) {
        ...
        loadingDialog.show();
        if (!NetworkUtils.checkNetWork(SyatemAchieveYouInfoActivity.this)) {
            Toast.makeText(SyatemAchieveYouInfoActivity.this, R.string.no_network, Toast.LENGTH_LONG).show();
            return;
        }
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (code == 0) {
                        ...
                        postion = answers.getString("position");
                        ...
                        loadingDialog.dismiss();
                        Toast.makeText(SyatemAchieveYouInfoActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                    }
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_open:
                ...
                if (audit.length() == 0) {
                    ...
                    View popupView;
                    // 声明平移动画
                    popupView = View.inflate(SyatemAchieveYouInfoActivity.this, R.layout.no_evaluate_item, null);
                    ...
                    popupWindow.showAtLocation(SyatemAchieveYouInfoActivity.this.findViewById(R.id.tv_position), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
                    ...
                    // 声明PopupWindow对应的视图
                    View popupView2;
                    popupView2 = View.inflate(SyatemAchieveYouInfoActivity.this, R.layout.parent_evaluate_item, null);
                    // 参数2,3：指明popupwindow的宽度和高度
                    ...
                    // 设置popupWindow的显示位置，此处是在手机屏幕底部且水平居中的位置
                    popupWindow2.showAtLocation(SyatemAchieveYouInfoActivity.this.findViewById(R.id.tv_position), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
                    try {
                    ...
                    // 声明PopupWindow对应的视图
                    View popupView3;
                    popupView3 = View.inflate(SyatemAchieveYouInfoActivity.this, R.layout.teacher_evaluate_item, null);
                    // 参数2,3：指明popupwindow的宽度和高度
                    ...
                    // 设置popupWindow的显示位置，此处是在手机屏幕底部且水平居中的位置
                    popupWindow3.showAtLocation(SyatemAchieveYouInfoActivity.this.findViewById(R.id.tv_position), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
                    try {
