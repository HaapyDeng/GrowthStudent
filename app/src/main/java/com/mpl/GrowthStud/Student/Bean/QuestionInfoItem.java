...
public class QuestionInfoItem {
    ...
    public JSONArray getAudit() {
        return audit;
    }

    public void setAudit(JSONArray audit) {
        this.audit = audit;
    }
    ...
    public QuestionInfoItem(String id, String name, int point, int type, JSONArray options, JSONArray answers, JSONArray audit) {
        this.id = id;
        this.name = name;
        this.point = point;
        this.type = type;
