...
public class MixtureInfoActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mixture_info);
        mContext = this;
    ...
    private void initData() {
        ...
        loadingDialog.show();
        if (!NetworkUtils.checkNetWork(MixtureInfoActivity.this)) {
            Toast.makeText(MixtureInfoActivity.this, R.string.no_network, Toast.LENGTH_LONG).show();
            return;
        }
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (code == 0) {
                        ...
                        loadingDialog.dismiss();
                        Toast.makeText(MixtureInfoActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                    }
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_open:
                ...
                if (audit.length() == 0) {
                    ...
                    popupWindow.showAtLocation(MixtureInfoActivity.this.findViewById(R.id.tv_answer), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
                    ...
                    // 声明PopupWindow对应的视图
                    View popupView2;
                    popupView2 = View.inflate(MixtureInfoActivity.this, R.layout.parent_evaluate_item, null);
                    // 参数2,3：指明popupwindow的宽度和高度
                    ...
                    // 设置popupWindow的显示位置，此处是在手机屏幕底部且水平居中的位置
                    popupWindow2.showAtLocation(MixtureInfoActivity.this.findViewById(R.id.tv_answer), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
                    try {
                    ...
                    // 声明PopupWindow对应的视图
                    View popupView3;
                    popupView3 = View.inflate(MixtureInfoActivity.this, R.layout.teacher_evaluate_item, null);
                    // 参数2,3：指明popupwindow的宽度和高度
                    ...
                    // 设置popupWindow的显示位置，此处是在手机屏幕底部且水平居中的位置
                    popupWindow3.showAtLocation(MixtureInfoActivity.this.findViewById(R.id.tv_answer), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
                    try {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (audit.length() == 0) {
                        ...
                        View popupView;
                        // 声明平移动画
                        popupView = View.inflate(MixtureInfoActivity.this, R.layout.no_evaluate_item, null);
                        // 参数2,3：指明popupwindow的宽度和高度
                        popupWindow = new PopupWindow(popupView, WindowManager.LayoutParams.MATCH_PARENT,
                                WindowManager.LayoutParams.WRAP_CONTENT);
                        // 设置点击popupwindow外屏幕其它地方不消失
