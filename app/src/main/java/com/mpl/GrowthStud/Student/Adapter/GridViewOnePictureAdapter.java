...
public class GridViewOnePictureAdapter extends android.widget.BaseAdapter {

    private Context mContext;
    private List<String> mList;
    private LayoutInflater inflater;

    public GridViewOnePictureAdapter(Context mContext, List<String> mList) {
    ...
    public int getCount() {
        ...
        if (count > MainConstant.ONE_SELECT_PIC_NUM) {
            return mList.size();
        } else {
            return count;
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = inflater.inflate(R.layout.grid_one_item, parent, false);
