            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (audit.length() == 0) {
                        ...
                        View popupView;
                        // 声明平移动画
                        popupView = View.inflate(WenZiInfoActivity.this, R.layout.no_evaluate_item, null);
                        ...
                        popupWindow.showAtLocation(WenZiInfoActivity.this.findViewById(R.id.tv_answer), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
                        ...
                        // 设置popupWindow的显示位置，此处是在手机屏幕底部且水平居中的位置
                        popupWindow2.showAtLocation(WenZiInfoActivity.this.findViewById(R.id.tv_answer), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
                        try {
                        ...
                        // 设置popupWindow的显示位置，此处是在手机屏幕底部且水平居中的位置
                        popupWindow3.showAtLocation(WenZiInfoActivity.this.findViewById(R.id.tv_answer), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
                        try {
